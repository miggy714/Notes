...
\begin{itemize}
    ...
    \item This generates a set of values r=$\brace r_1, r_2, /dots , r_m$
...
\end{tabular}
\\~\\
INSERT OBSTR Meter Theory image
...
INSERT table and plot for delta P and r
\subsubsection{algorithm}
\begin{itemize}
    \item generate a random value for $\rho_o$
    \begin{itemize}
        \item rhoD $<-$ rnorm(n=1,mean=$\bar{\rho}_0$, sd = $u_{\rho_0}$)
    \end{itemize}
